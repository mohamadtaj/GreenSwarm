...
def train_centralized(dataset_name, x_train, y_train, x_test, y_test, BATCH_SIZE, EPOCHS, input_size, output_size, optimizer, loss):

    centralized_model = model(dataset_name, input_size, output_size)
