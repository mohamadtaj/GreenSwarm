...
def train_model_fedavg(env, BATCH_SIZE):
...
def evaluate_model_fedavg(env, x_test, y_test, BATCH_SIZE):
...
def train_network_fedavg(env, dataset_name, x_test, y_test, BATCH_SIZE, EPOCHS, input_size, output_size, optimizer, loss):
    ...
    print()
    print("Classic Swarm Model Training... ")
    print()
    ...
    for epoch_num in range(EPOCHS):
        ...
        avg_train_loss, avg_train_accuracy = train_model_fedavg(env, BATCH_SIZE) # perform one round of training

        avg_test_loss, avg_test_accuracy = evaluate_model_fedavg(env, x_test, y_test, BATCH_SIZE) # perform one round of evaluation
